...
router.get("/me", index_js_1.verifyWorkerJwtTokenMiddleware, index_js_1.meController);
router.get("/signOut", index_js_1.verifyWorkerJwtTokenMiddleware, index_js_1.signOutController);
